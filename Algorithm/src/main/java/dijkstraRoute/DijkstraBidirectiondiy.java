 ...
 * @author Peter Karich
 */
public class DijkstraBidirectiondiy extends AbstractNonCHBidirAlgo {
    public DijkstraBidirectiondiy(Graph graph, Weighting weighting, TraversalMode tMode, PathCache pathCache) {
        super(graph, weighting, tMode,pathCache);
    }
