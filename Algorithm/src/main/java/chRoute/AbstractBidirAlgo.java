...
public abstract class AbstractBidirAlgo implements EdgeToEdgeRoutingAlgorithm {
    ...
    public static double cacheTime = 0;
    public static double algoTime = 0;
    public static double extractTime = 0;
    public static double calcEdgeTime = 0;
...
//        if(pathCache.pathIndexMap.containsKey(from)&&pathCache.pathIndexMap.containsKey(to)&&pathCache.cacheType!=0){
...
//            }
        ...
        extractTime += t3-t2;
//        System.out.println("algoTime: " + algoTime + " extractTime: " + extractTime +" cacheTime: "+cacheTime+" edgeTime:"+calcEdgeTime);
