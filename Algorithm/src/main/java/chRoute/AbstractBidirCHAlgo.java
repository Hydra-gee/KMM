...
public abstract class AbstractBidirCHAlgo extends AbstractBidirAlgo implements EdgeToEdgeRoutingAlgorithm {
    ...
    public AbstractBidirCHAlgo(RoutingCHGraph graph, TraversalMode tMode, PathCache pathCache) {
        super(tMode,pathCache,graph.getBaseGraph());
        this.graph = graph;
...
//        return null;
        return new NodeBasedCHBidirPathExtractor(graph).extract2(fromCache,toCache, bestWeight,pathCache);
    }
